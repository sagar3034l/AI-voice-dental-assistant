...
function HowItWorks() {
  return (
    <section id='howitworks' className='relative py-32 px-6 outline-hidden z-10 max-w-7xl mx-auto'>
      <div className='text-center mb-20'>
        <div className='inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-primary to-primary/10 rounded-full border border-primary/10 backdrop-blur-sm mb-6'>
