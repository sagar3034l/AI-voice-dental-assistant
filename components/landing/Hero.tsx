...
function Hero() {
  return (
    <section className="relative min-h-[calc(100vh-4rem)] flex items-center overflow-visible pt-20 pb-16">
      {/* GRID BG  */}
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 text-sm font-semibold text-foreground">
                      ...
                      <StarIcon className="size-4 fill-primary text-primary" />
                      <StarIcon className="size-4 fill-primary text-primary" />
                      <span className="ml-1 text-muted-foreground">Loved by 2,000+ patients</span>
                    </div>
                    <p className="max-w-md text-sm leading-relaxed text-muted-foreground">
                      The AI assistant made it so easy to get quick guidance before booking my
                      appointment.
                    </p>
                  </div>
                </div>
